...
| Test harness | **Implemented** — Go + Docker driver under `bitcoin-multicast-test/harness/`. 40 scenarios. `go test` only, no docker-compose. |
...
| [docker-test-infra.md](docker-test-infra.md) | Implemented Go harness under `bitcoin-multicast-test/harness/` — driver, bridge, env, metrics |
